...
// //             .title("Test Bidding")
// //             .description("Test Description")
// //             .bidMethod(BidMethod.정가제안)
// //             .status(BiddingStatus.대기중)
// //             .startDate(LocalDateTime.now())
// //             .endDate(LocalDateTime.now().plusDays(30))
// //             .quantity(10) // quantity 필드 추가
// //             .unitPrice(BigDecimal.valueOf(10000))
...
// //         // PENDING 상태 입찰 공고 조회
// //         Map<String, Object> params = new HashMap<>();
// //         params.put("status", BiddingStatus.대기중);
...
// //         if (!pendingBiddings.isEmpty()) {
// //             assert pendingBiddings.stream().allMatch(b -> b.getStatus() == BiddingStatus.대기중);
// //             System.out.println("PENDING 상태 입찰 공고 조회 성공. 총 " + pendingBiddings.size() + "개의 입찰 공고가 있습니다.");
// //         } else {
// //             System.out.println("PENDING 상태의 입찰 공고가 없습니다.");
// //         }
...
// //     }
// // }
// >>>>>>> d30772e (feat:입찰공고, 공급사 평가, 입찰계약, 발주 기능 구현)
