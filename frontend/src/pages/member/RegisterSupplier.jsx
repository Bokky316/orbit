...
export default function RegisterSupplier() {
 ...
 const handleSubmit = () => {
   ...
   .catch((error) => {
     setLoading(false);
     console.error("협력업체 가입 중 오류 발생:", error);
     setSnackbar({
       open: true,
       message: "서버 오류가 발생했습니다. 다시 시도해주세요",
       severity: "error"
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12}>
              <TextField
                ...
                helperText={errors.password || "비밀번호는 4자 이상 16자 이하로 입력해주세요 (영문/숫자/특수문자 포함)"}
                InputProps={{
                  endAdornment: (
