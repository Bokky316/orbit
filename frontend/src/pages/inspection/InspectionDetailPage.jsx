...
const InspectionDetailPage = ({ userRole = "BUYER" }) => {
          ...
          const filesData = [
            {
              id: 1,
              inspection_id: id,
              file_path: "/uploads/inspections/report_123.pdf",
              file_name: "검수보고서.pdf",
              file_type: "application/pdf",
              file_size: 1024000,
              upload_date: "2025-03-08T15:30:00",
              description: "검수 보고서"
            },
            {
              id: 2,
              inspection_id: id,
              file_path: "/uploads/inspections/package_img.jpg",
              file_name: "포장상태사진.jpg",
              file_type: "image/jpeg",
              file_size: 2048000,
              upload_date: "2025-03-08T15:35:00",
              description: "손상된 포장 사진"
            }
          ];
  ...
  // 상태 정보 가져오기
  const statusInfo =
    resultStatusMap[inspection.result] || resultStatusMap["검수대기"];
